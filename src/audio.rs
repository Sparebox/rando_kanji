...
impl SoundBuffers {
    pub fn new() -> Self {
        ...
        let correct_ans = SoundBuffer::from_file("res/sounds/correct.wav").expect(message);
        let incorrect_ans = SoundBuffer::from_file("res/sounds/incorrect.wav").expect(message);
